...
> <span style="font-size:1.5em;">Which tree algorithm does scikit-learn use? CART it is, more on that on the [scikit learn page](http://scikit-learn.org/stable/modules/tree.html#tree-algorithms).</span>
{: .notice--info}
...
> <span style="font-size:1.5em;">For regression trees, they are either chosen to minimize Variance (Reduction in Variance approach) OR MAE (Mean Absolute Error) within all of the subsets.</span>
{: .notice--info}
