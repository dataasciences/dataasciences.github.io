---
title: "What changes in Python 3.8 & above?"
...
But among all these upgrades, python improved marginally in 3.8 over 3.7 in some areas and added new syntax, speed improvements but still maintaining the tradition from the earlier release. 
...
One of the most talked-about features is the introduction of the assignment expression operator (:=), often referred to as the "walrus operator". It allows assignment within expressions, enabling assignments to be made as part of larger expressions.
...
* greet("Bob", greeting="Hi"): Is actually a correct usage, demonstrating greeting can be a keyword argument while name remains positional.
...
2. Memory Usage Improvements
  ...
  Shared Keys Dictionaries: Dictionaries with identical keys share a common keys object, reducing memory usage and improving performance when creating many similar dictionaries.
...
# Both dict1 and dict2 share the same keys object internally, saving memory
```
...
These are some of the improvements over version 3.7 and earlier versions. Its beneficial to consider these updates when you develop your applications to see an overall performance improvement of your application.
